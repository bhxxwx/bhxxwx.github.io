...
<input name="mm" type="text" class="txts" id="mm" value="请输入<%=duan2%>" placeholder="请输入<%=duan2%>"  onfocus="this.value=''" onBlur="this.value='请输入<%=duan2%> '" />
</div>
...
<a href="http://bhxxwx.github.io/2/2.html" target="_blank">  王翔技术支持</a></span>
